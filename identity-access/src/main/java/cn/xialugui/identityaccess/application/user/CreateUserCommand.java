 ...
 * 创建命令
 * <p>
 * 这里没有使用领域对象，而是一些基本类型。其原因可以参考{@link UserApplicationService#register(Username, Nickname, Password, MobilePhone, Email)}
 * </p>
 * 我们可以将命令对象看作是DTO，但是它所能表达的比DTO要多。最突出就是以其操作来命名命令对象，
 * 所以其目的和意图更加明显。我们可以将命令对象用作应用服务方法的签名参数，详情见{@link UserApplicationService#register(CreateUserCommand)}
 * <p>
